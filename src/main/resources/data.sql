-- Creación de roles
INSERT INTO `gr169`.`role` (`id`, `description`, `name`, `soft_deleted`, `timestamp`) SELECT '1', 'Administrador General', 'ADMIN2', 0, NOW() WHERE NOT EXISTS (SELECT * FROM role WHERE id = '1');
